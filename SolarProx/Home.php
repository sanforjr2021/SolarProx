        ...
        <div class="col-md-8">
            ...
            <div class="section">
                ...
                <?php
                    ...
                    echo '<table style="width: 100%"><tr class="first"><th>Box Name</th><th>Box Status&emsp;</th><th>View Machine</th><th>Rollback</th></tr>';
                        ...
                        if($Box -> status == "running")
                            {
                                ...
                                $button3 =  "<td><form action='Home.php' method='post'><input type='submit' name='".$rollback."' value='Rollback' /></form>&emsp;</td>";
                                $button4 =  "<td><form action='ViewMachine.php' method='post'><input type='submit' name='".$BoxID."' value='View Machine' /></form>&emsp;</td>";
                                echo $button3;
                                echo $button4;
